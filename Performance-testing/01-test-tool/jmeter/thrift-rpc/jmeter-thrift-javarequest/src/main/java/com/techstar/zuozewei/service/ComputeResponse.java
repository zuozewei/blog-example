...
public class ComputeResponse implements org.apache.thrift.TBase<ComputeResponse, ComputeResponse._Fields>, java.io.Serializable, Cloneable, Comparable<ComputeResponse> {
  ...
  private static class ComputeResponseStandardScheme extends StandardScheme<ComputeResponse> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, ComputeResponse struct) throws TException {
      ...
      if (!struct.isSetErrorNo()) {
        throw new TProtocolException("Required field 'errorNo' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetComputeRet()) {
        throw new TProtocolException("Required field 'computeRet' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }

    public void write(org.apache.thrift.protocol.TProtocol oprot, ComputeResponse struct) throws TException {
      struct.validate();
  ...
  private static class ComputeResponseTupleScheme extends TupleScheme<ComputeResponse> {
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ComputeResponse struct) throws TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ComputeResponse struct) throws TException {
